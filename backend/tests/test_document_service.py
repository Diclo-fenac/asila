...
from services.documents.service import create_document, parse_and_persist_chunks
...
async def test_parse_and_persist_chunks_creates_chunk_entities():
    ...
    with patch("services.documents.service.httpx.AsyncClient") as mock_client_cls:
        client = AsyncMock()
