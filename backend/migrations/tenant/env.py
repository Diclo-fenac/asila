...
async def run_async_migrations() -> None:
    ...
    """
    # For tenant migrations, we might want to override the URL dynamically
    # For now, we take it from the config or an environment variable
    url = os.getenv("TENANT_DATABASE_URL", config.get_main_option("sqlalchemy.url"))
