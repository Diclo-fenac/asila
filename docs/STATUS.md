...
| 3. Ingestion and AI | Complete for text v1 | Deterministic chunking, source/hash idempotency, durable native PostgreSQL embedding jobs, retry/backoff, Ollama/Gemini/OpenAI-compatible adapters. |
